  ...
  return (
    ...
    >
      ...
      <div className='text-zone'>
        ...
        <p>
          Specialize in front-end development using technologies such as HTML5,
          CSS3, Javascript, React, Bootstrap, SASS, etc..
        </p>
        <p>
          I put a lot of time into making web applications user friendly like
          proper layout for components, making applications responsive and good
          looking
        </p>
        <p>
          I would love to use my skill set to contribute to a companies
          application. I am always looking to improve my self and learning new
          skills to benefit myself and the project I work on
        </p>
      </div>
      ...
      <div className='skills-right-side'>
        ...
        {/* CSS */}
        <svg
          xmlns='http://www.w3.org/2000/svg icon-2'
          viewBox='0 0 128 128'
        ...
        {/* Javascript */}
        <svg
          xmlns='http://www.w3.org/2000/svg icon-3'
          viewBox='0 0 128 128'
          className='skills-icons'
        >
        ...
        {/* React */}
        <svg
          xmlns='http://www.w3.org/2000/svg icon-4'
          viewBox='0 0 128 128'
          className='skills-icons'
        >
          <g fill='#61DAFB'>
        ...
        {/* Material Ui */}
        <svg
          xmlns='http://www.w3.org/2000/svg icon-5'
          viewBox='0 0 128 128'
          className='skills-icons'
        >
          <path
        ...
        {/* SASS */}
        <svg
          xmlns='http://www.w3.org/2000/svg icon-6'
          viewBox='0 0 128 128'
          className='skills-icons'
        >
          <path
        ...
        {/* REDUX */}
        <svg
          xmlns='http://www.w3.org/2000/svg icon-7'
          viewBox='0 0 128 128'
          className='skills-icons'
        >
        ...
        {/* Firebase */}
        <svg
          xmlns='http://www.w3.org/2000/svg icon-9'
          viewBox='0 0 128 128'
          className='skills-icons'
        >
          <g fill='#f58220'>
